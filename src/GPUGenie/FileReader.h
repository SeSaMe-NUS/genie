...
// 0   1   6      0.04        1
// ....
void read_query(std::vector<GPUGenie::attr_t>& data, const char* file_name,
		int num);

//convert a csv file to a binary file, the third arg determines write style(override or append)
void csv2binary(const char* csvfile, const char* binaryfile, bool app_write =
		false);
...
void read_file(const char* fname, int **_data, unsigned int& item_num,
